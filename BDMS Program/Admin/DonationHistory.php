...
if ($conn->connect_error){
    ...
    $stmt = "SELECT * FROM Donation_History WHERE (Status = 'Approved' OR Status = 'Rejected')";
...
<head>
    ...
    <link rel="stylesheet" href="AdminStyles/DonationHistory.css">
</head>
<body style="margin: 0; padding-top: 40px; background-color: rgb(243, 245, 249);">
    ...
    <div class="Contents">
        ...
        <p class="DonationHistoryTitle">BLOOD DONATION HISTORY</p>
        <table class="DonationHistoryTable Text">
            ...
            ?>
                <tr style="background-color: rgb(227, 226, 226);">
                    ...
                    <td style="display: flex; width: 237px;">
