...
<head>
    ...
    <link rel="stylesheet" href="AdminStyles/PatientDetails.css">
</head>
<body style="margin: 0; padding-top: 40px; background-color: rgb(243, 245, 249);">
    ...
    <div class="Contents">
        ...
        <p class="PatientDetailsTitle">PATIENT DETAILS</p>
        <table class="PatientDetailsTable Text">
            ...
            ?>
                <tr style="background-color: rgb(227, 226, 226);">
                    ...
                    <td style="display: flex; width: 180px;">
                        ...
                        <form method="POST" action="DeletePatient.php" onsubmit="DeletePatient(this);">
...
function DeletePatient(form) {
    ...
    swal({
        title: "Are you sure?",
        text: "This patient details will be deleted permanently",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
